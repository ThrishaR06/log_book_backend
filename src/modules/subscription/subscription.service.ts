...
export class SubscriptionService {
    ...
    async mySubscription(doctorId: number) {
        ...
        try {
            ...
            const subscription =
                await this.repository.getCurrentSubscription(doctorId);
            ...
            const [
                ...
                this.repository.getUsedOperationalRecords(doctorId),

                this.repository.getUsedTemplates(doctorId),

                this.repository.getUsedStorage(doctorId)
